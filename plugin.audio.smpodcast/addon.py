...
def Main_Menu():
    addMenuItem('[COLOR springgreen][B]News and Updates[/B][/COLOR]', 'popup', 101, os.path.join(ARTFOLDER, 'updates.png'), DEFAULTFANART)
    ...
    addSectionItem('[COLOR=snow]Follow on Twitter:[/COLOR] [COLOR=springgreen]@tantrumdev[/COLOR]', os.path.join(ARTFOLDER, 'twitter.png'), DEFAULTFANART)
    addSectionItem('[COLOR=snow]Subscribe on YouTube:[/COLOR] [COLOR=springgreen]http://youtube.tantrumtv.com[/COLOR]', os.path.join(ARTFOLDER, 'youtube.png'), DEFAULTFANART)
###################################################################################
...
def Update_News():
        localnewsfile = os.path.join(THISADDONPATH, 'whatsnew.txt')
