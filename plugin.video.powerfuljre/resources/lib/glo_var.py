...
# Addon Name: The Joe Rogan Experience
# Addon id: plugin.video.powerfuljre
...
ADDONTITLE          = base64.b64decode(b'VGhlIEpvZSBSb2dhbiBFeHBlcmllbmNl')
...
#######################################################################
# Filename Variables 
BASEURL             = base64.b64decode(b'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL211YWRkaWJ0dHYvdGFudHJ1bXhtbHMvbWFzdGVyL3Bvd2VyZnVsanJlLw==')
